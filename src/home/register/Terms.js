...
function Terms({onCheck,onback,onsubmit,showmes,message}) {
    return (
       ...
       <h1>Terms and Conditions</h1>     
        <p className="text-secondary">Last updated: February 11, 2021</p>
...
Company (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to TaboGarahe.
...
Website refers to TaboGarahe, accessible from tabogarahe.com
...
By email: lumangyao112@gmail.com
